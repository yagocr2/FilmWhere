...
namespace FilmWhere.Server.Migrations
{
    ...
    [Migration("20250614215636_borrado_en_cascada")]
    partial class borrado_en_cascada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmWhere.Server.Models.Denuncia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("UsuarioDenunciadoId")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("UsuarioDenuncianteId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("UsuarioDenuncianteId");
            ...
            modelBuilder.Entity("FilmWhere.Server.Models.Denuncia", b =>
                {
                    b.HasOne("FilmWhere.Models.Usuario", "UsuarioDenunciado")
                        .WithMany("DenunciasRecibidas")
                        .HasForeignKey("UsuarioDenunciadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilmWhere.Models.Usuario", "UsuarioDenunciante")
