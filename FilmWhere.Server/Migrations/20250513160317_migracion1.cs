    ...
    public partial class migracion1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioSeguidor", x => new { x.SeguidorId, x.SeguidoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favoritos", x => new { x.UsuarioId, x.PeliculaId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculaPlataformas", x => new { x.PeliculaId, x.PlataformaId });
                    table.ForeignKey(
                        name: "FK_PeliculaPlataformas_Peliculas_PeliculaId",
                        column: x => x.PeliculaId,
                        principalTable: "Peliculas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PeliculaPlataformas_Plataformas_PlataformaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeliculaPlataformas_PlataformaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reseñas_UsuarioId_PeliculaId",
                table: "Reseñas",
